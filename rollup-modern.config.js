...
const copyConfig = {
  targets: [
    ...
    { src: 'node_modules/@polymer', dest: 'build/modern/node_modules' },
    { src: 'images', dest: 'build/modern' },
    { src: 'data', dest: 'build/modern' },
    { src: 'assets', dest: 'build/modern' },
...
const config = {
  input: 'src/root-element.js',
  output: {
    dir: 'build/modern/src',
    format: 'es',
  },
  plugins: [minifyHTML(), copy(copyConfig), resolve(), filesize(filesizeConfig)],
